class Sprite{ //destruct objct
  ...
  //y position has 10 frames added onto for each frame looped over
...
class Fighter extends Sprite{ //destruct objct
  constructor({position, velocity,color = 'red', imageSrc,scale = 1, framesMax = 1,offset = {x:0, y:0},sprites,attackBox = {offset: {}, width: undefined, height: undefined}}){
    super({
      position,
      imageSrc,scale,framesMax,offset
    })
    //this.position = position
    ...
    for(const sprite in this.sprites){
      ...
      sprites[sprite].image.src =
      sprites[sprite].imageSrc
    }
  }
